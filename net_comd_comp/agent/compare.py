...
SYSTEM_PROMPT = """You are a senior network engineer specializing in Cisco IOS/XE and Arista EOS.
...
- Note when a feature is proprietary or requires a license.
...
def _resolve_direction(
    ...
    arista_markers = ("eos", "arista", "vxlan", "mlag")
    cisco_markers = ("ios", "cisco", "nx-os", "nexus")
...
class CommandComparator:
    def __init__(self, searcher: SemanticSearcher, chat: OllamaChat):
